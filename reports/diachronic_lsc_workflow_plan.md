...
| Next action | Plan `notebooks/01_sentiment/01_vad_valence.ipynb` using the shared context table |
...
| 3 | Sentiment | `notebooks/01_sentiment/01_vad_valence.ipynb` | pending | shared context table; NRC-VAD v2.1 | `data/processed/lsc/sentiment/` |
