...
\toprule
Validation target & Period & Support & Precision & Recall & FPR & F1 \\
\midrule
Substantive target discourse & 2014--2017 & 45/67 & .884 [.75, .96] & .844 [.71, .94] & .227 [.08, .45] & .864 [.78, .93] \\
 & 2018--2022 & 46/67 & .816 [.68, .91] & .870 [.74, .95] & .429 [.22, .66] & .842 [.76, .91] \\
 & 2023--2026 & 50/66 & .976 [.87, 1.00] & .800 [.66, .90] & .062 [.00, .30] & .879 [.80, .94] \\
\addlinespace
Clinical framing & 2014--2017 & 36/45 & .897 [.76, .97] & .972 [.85, 1.00] & .444 [.14, .79] & .933 [.87, .99] \\
 & 2018--2022 & 37/46 & .971 [.85, 1.00] & .892 [.75, .97] & .111 [.00, .48] & .930 [.86, .99] \\
 & 2023--2026 & 32/50 & .833 [.65, .94] & .781 [.60, .91] & .278 [.10, .53] & .806 [.68, .90] \\
\addlinespace
Lived-experience framing & 2014--2017 & 11/45 & .667 [.35, .90] & .727 [.39, .94] & .118 [.03, .27] & .696 [.43, .88] \\
