...
Table~\ref{tab:lsc-regression-target-frames} reports the target trend models. At the uncorrected $p<.05$ level, autism salience declined; frame composition shifted toward lived-experience; no target sentiment slope differed from zero; intensity increased for ADHD overall and for the clinical frames of both targets; and breadth decreased for ADHD overall, ADHD clinical contexts, and autism lived-experience contexts. The autism clinical breadth OLS slope was nominally positive but was not retained by the AR(1) sensitivity model.
