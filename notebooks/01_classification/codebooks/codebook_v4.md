...
**Codebook version:** v0.4  
**Status:** Final annotation codebook  
...
- target-specific experiences, identities, needs, practices, services, or
  representation;
- a meaningful class of conditions or populations that includes the target,
  when the passage's claim clearly applies to ADHD/autism.

A target mention alone is not substantive discourse.

### 5.2 Code `TRUE` when

The passage contains enough target-relevant content to determine whether a
...
- one example in a broader list of conditions, populations, providers,
  resources, or topics, when the passage makes neither a target-specific claim
  nor a meaningful class-level claim that clearly applies to the target;
- a generic statement that merely says support or resources exist;
- a product advert, marketplace listing, classified ad, SEO product blurb, or
  commercial claim dominated by sales or listing metadata, even when it makes
  a brief ADHD/autism health claim;
...
resource blurbs can still be non-substantive. A commercial passage becomes
substantive only when it contains coherent non-promotional target discourse
...
replacement for the definition above. Do not use it to override a coherent
claim about a meaningful class that clearly includes the target.
...
- concrete institutional arrangements organised specifically for ADHD/autistic
  people, including education or residential provision;
- legal, disciplinary, or forensic arguments that use the target to explain,
  mitigate, contextualise, or contest behaviour, culpability, risk, or
  sophistication.
...
- a speaker uses symptom language to interpret their own feelings, behaviour,
  relationships, work, school, or everyday life without also treating the
  target as a formal clinical object;
- clinical terminology is quoted but the passage does not meaningfully discuss
  the target as a clinical object.

Clinical evidence must be substantively developed and either target-specific or
part of a class-level claim that clearly applies to the target.
...
Lived-experience evidence must be substantively developed and either
target-specific or part of a class-level claim that clearly applies to the
target.
...
A diagnosis mention can locate a person within a lived account without adding a
clinical frame. Add clinical only when the passage independently discusses the
target as an object of diagnosis, assessment, treatment, medication,
professional interpretation, or formal impairment evaluation.

### 8.2 Target in lists and category-set claims

A target appearing in a list is non-substantive only when it functions merely
as an example and the passage makes neither a target-specific claim nor a
meaningful class-level claim that clearly applies to the target. List length is
only a cue: a two-item list can be generic, while a longer list can be
substantive.

- Code `FALSE` when ADHD/autism appears only in a generic list of conditions,
  populations, providers, resources, services, or topics.
- Code `TRUE` when the passage develops a coherent claim about a category-set
  that includes the target and the claim clearly applies to ADHD/autism.
- Once Stage 0 is `TRUE`, assign frames from the function of that claim rather
  than from the list itself.

A statement that a map, directory, programme, provider, or resource merely
`covers` or `includes` listed conditions or topics is still a generic list. It
does not become a meaningful class-level claim without a substantive
proposition that applies to the listed class.

> "Characteristics such as mental health, learning disabilities, sensory
> processing or autism conditions can play a role in distressed behaviour."

This is substantive clinical discourse because the course makes an explanatory
and support-oriented claim about a meaningful class that clearly includes
autism.

> "Parents of children with ADHD, anxiety, OCD, ASD, or PANS/PANDAS often face
> emotional and behavioral extremes that can feel impossible to manage."

This is substantive lived-experience discourse because the class-level claim
clearly applies to ADHD/autism and foregrounds family experience. The diagnostic
list alone does not add a clinical frame.

### 8.3 Services, support, and institutional provision

Distinguish a concrete target-specific provision from a generic service or
support claim.

- Code clinical when the passage explicitly presents ADHD/autism as something a
  service assesses, treats, manages, or organises institutional provision for.
- A concrete institutional arrangement designed for ADHD/autistic people is
  substantive even without extensive clinical detail.
...
- Generic claims such as "we support people with autism" are insufficient
  unless the passage identifies the form or purpose of that support.

> "The school was opened to provide education and some residential places to
> local children on the autism spectrum."

This is substantive clinical/institutional-support discourse because it
specifies education and residential places organised for autistic children. Do
not add lived experience unless the passage also develops people's or families'
experience, participation, identity, or social meaning.

### 8.4 First-person, family, and caregiver language
...
- A brief caregiver account is substantive lived experience when it links an
  ADHD/autistic child to a concrete everyday action, strategy, adaptation,
  routine, or practical problem. Extended emotional detail is not required.
...
A child's ADHD/autism stated only as bare status remains non-substantive when no
target-linked practice, problem, or adaptation is supplied.

### 8.5 Self-theorising symptom language

When a speaker uses ADHD/autism-related symptom language to interpret their own
feelings, behaviour, relationships, work, school, or everyday life, code lived
experience rather than clinical framing. Add clinical only when the passage also
treats the target as an object of diagnosis, assessment, treatment, medication,
professional interpretation, formal impairment evaluation, or institutional
management.

> "All of these emotions, probably strengthened by my ADHD - I remember hearing
> that ADHD makes emotions feel stronger - are giving me a sense of confusion
> and emptiness."

This is `lived_only`: symptom language functions as self-explanation within an
everyday emotional account, not as formal clinical interpretation.

### 8.6 Coping versus intervention
...
### 8.7 Neurodiversity, accessibility, and accommodation
...
### 8.8 Professional profiles and credentials
...
### 8.9 Legal, disciplinary, and forensic mitigation

Code substantive clinical discourse when ADHD/autism is invoked to explain,
mitigate, contextualise, or contest behaviour, culpability, risk, or
sophistication in a legal, disciplinary, or forensic argument. This remains
substantive even when the target mention is brief because the diagnosis
functions as an explanatory clinical object.

> "Roberts had recently been diagnosed with ADHD, had been prescribed
> medication and was not a 'sophisticated criminal'."

This is `clinical_only`. Do not add lived experience unless the passage also
foregrounds the person's own perspective, everyday life, stigma, relationships,
or social participation.

### 8.10 Organisations, events, titles, and media
...
| "The school provides education and residential places to local children on the autism spectrum." | `TRUE` | `TRUE` | `FALSE` | `clinical_only` | It specifies a concrete institutional provision organised for autistic children. |
...
| "My ADHD may make these emotions feel stronger, leaving me confused and empty." | `TRUE` | `FALSE` | `TRUE` | `lived_only` | Symptom language functions as self-explanation within lived experience. |
...
| "Topics include ADHD, anxiety, and OCD." | "Parents of children with ADHD, anxiety, or OCD often feel overwhelmed by emotional extremes." | A generic topic list is insufficient; a coherent class-level family-experience claim clearly applies to ADHD. |
...
- Generic names, lists, and support language did not trigger a substantive
  frame by themselves; any class-level claim clearly applies to the target.
- Clinical and lived-experience evidence each independently meet their
  definitions.
- Diagnosis status; words such as `diagnosed`, `patient`, `support`, `therapy`,
  or `treatment`; first-person language; and professional identity did not
  trigger a frame by themselves.
- Concrete institutional provision, self-theorising symptom language, and
  legal/forensic mitigation were coded according to their discourse function.
